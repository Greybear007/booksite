...
class Books(models.Model):
    ...
    translator = models.CharField(max_length=50, verbose_name='译者', blank=True)
    ...
    pic = models.ImageField(upload_to='img',max_length=100, verbose_name='图片', blank=True)
...
class Author(models.Model):
	...
	bron_date = models.DateField(verbose_name='出生日期', blank=True)
	dead_date = models.DateField(verbose_name='逝世日期', blank=True)
	title = models.CharField(max_length=50, verbose_name='头衔',blank=True)
	url = models.URLField(verbose_name='链接', blank=True)
